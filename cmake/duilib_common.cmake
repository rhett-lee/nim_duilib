...
if(DUILIB_ENABLE_CEF)
    ...
    elseif(DUILIB_OS_MACOS)
        set(CEF_LIBS "${DUILIB_SRC_ROOT_DIR}/Frameworks/Chromium Embedded Framework.framework/Chromium Embedded Framework" ${CEF_WRAPPER_LIB_NAME})
    else()
...
if(DUILIB_ENABLE_SDL)
    ...
    if(EXISTS "${SDL_SRC_ROOT_DIR}/lib64/")
        set(SDL_LIB_PATH "${SDL_SRC_ROOT_DIR}/lib64")
    else()
        set(SDL_LIB_PATH "${SDL_SRC_ROOT_DIR}/lib")
    endif()
    set(SDL_LIBS SDL3)
endif()
...
if(DUILIB_LOG)
    ...
    if(DUILIB_ENABLE_SDL)        
        message(STATUS "SDL_SRC_ROOT_DIR: ${SDL_SRC_ROOT_DIR}")
        message(STATUS "SDL_LIB_PATH: ${SDL_LIB_PATH}")

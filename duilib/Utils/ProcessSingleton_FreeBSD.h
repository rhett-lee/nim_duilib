#ifndef UI_UTILS_PROCESS_SINGLETON_FREEBSD_H_
#define UI_UTILS_PROCESS_SINGLETON_FREEBSD_H_
...
#endif //DUILIB_BUILD_FOR_FREEBSD
#endif // UI_UTILS_PROCESS_SINGLETON_FREEBSD_H_

...
|文本选择               | Shift + Left键                 |              |选择光标到向左逐字符扩大的范围内的文本 |
|文本选择               | Shift + Right键                |              |选择光标到向右逐字符扩大的范围内的文本 |
|文本选择               | Shift + Up键                   |              |选择光标到向上逐行扩大的范围内的文本 |
|文本选择               | Shift + Down键                 |              |选择光标到向下逐行扩大的范围内的文本 |
|文本选择               | Shift + Home键                 |              |选择光标到行首范围内的文本 |
|文本选择               | Shift + End键                  |              |选择光标到行尾范围内的文本 |
|文本选择               | Shift + Page Up键              |              |选择光标到向上按页逐步扩大的范围内的文本 |
|文本选择               | Shift + Page Down键            |              |选择光标到向下按页逐步扩大的范围内的文本 |
|光标定位               | 鼠标左键/右键单击 | 完成     |              |
|光标向左移动一个字符   | Left键            | 完成     |              |
...
|光标移到行尾           | End 键            |          |              |
|光标向上移动一页       | Page Up 键        |          |              |
|光标向下移动一页       | Page Down 键      |          |              |
|光标向左移动一个词     | Ctrl+Left键       |          |              |
|光标向右移动一个词     | Ctrl+Right键      |          |              |
|光标移动到文档开头     | Ctrl+Home键       |          |              |
|光标移动到文档末尾     | Ctrl+End键        |          |              |
|视图移动到上面的行 | Ctrl+Up键             |          |光标位置不变  |
|视图移动到下面的行 | Ctrl+Down键           |          |光标位置不变  |
|视图向上移动一页   | Ctrl+Page Up键        |          |光标位置不变  |
|视图向下移动一页   | Ctrl+Page Down键      |          |光标位置不变  |
|按字符向后删除         | Delete            | 完成     |              |

#ifndef EXAMPLES_RENDER_TEST3_H_
#define EXAMPLES_RENDER_TEST3_H_
...
public:
    explicit RenderTest3(ui::Window* pWindow);
    virtual ~RenderTest3() override;
...
#endif //EXAMPLES_RENDER_TEST3_H_

...
{
    if ((nullptr == pMedDest) || (nullptr == pMedSrc) || (nullptr == pFmtSrc)) {
        return E_INVALIDARG;
    }
...
{
    if (FAILED(CoCreateInstance(CLSID_DragDropHelper, nullptr, CLSCTX_INPROC_SERVER, IID_IDragSourceHelper, (void**)&m_pDragSourceHelper))) {
